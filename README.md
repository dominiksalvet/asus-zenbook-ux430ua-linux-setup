**This program is no longer maintained and has been replaced by [asus-fan-control](https://github.com/dominiksalvet/asus-fan-control) and [ux430ua-jack-volume](https://github.com/dominiksalvet/ux430ua-jack-volume).**
